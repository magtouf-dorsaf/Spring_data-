...
<center>
	...
	<!-- l'action hatha bch ymchi ylawej 3l mapping saveProduit -->
						<!-- l e hathi lezem tkoun mwjouda fl meth l fiha getmapping -->
	...
	<div class="form-group">
		...
		<h3>nom:<form:input path="nom" class="form-control" /></h3>
		...
		<h3>projet: <form:select items="${lp}" path="projet.id" itemValue="id" itemLabel="titre" class="form-control form-control-lg"></form:select> </h3>
   		<h3>fonction:<form:input path="fonction" class="form-control" /></h3>
    </div>
    <center>
